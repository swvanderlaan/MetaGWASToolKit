...
#SBATCH -o /hpc/dhl_ec/svanderlaan/projects/metagwastoolkit.log 	          # the log file of this job
#SBATCH --error /hpc/dhl_ec/svanderlaan/projects/metagwastoolkit.errors    # the error file of this job
...
### PARAMETERS SLURM
#SBATCH --job-name=metagwastoolkit                                  														# the name of the job
#SBATCH -o /hpc/dhl_ec/svanderlaan/projects/consortia/CHARGE_cIMT_Sex/CHARGE_cIMT_MALES/metagwastoolkit.prep.log 	        # the log file of this job
#SBATCH --error /hpc/dhl_ec/svanderlaan/projects/consortia/CHARGE_cIMT_Sex/CHARGE_cIMT_MALES/metagwastoolkit.prep.errors	# the error file of this job
