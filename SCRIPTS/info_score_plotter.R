...
cat("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    IMPUTATION QUALITY SCORE PLOTTER v1
    \n
    * Version: info_plotter_v1.1.1
    * Last edit: 2016-07-28
...
#opt$imageformat="PNG"
#opt$resultfile="/Users/swvanderlaan/PLINK/_CARDIoGRAM/cardiogramplusc4d_1kg_cad_add/cad.add.160614.website.info.txt.gz"
...
cat("\n++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
cat("Wow. We are finally starting \"Imputation Quality Score Plotter\". ")
#--------------------------------------------------------------------------
...
if(!is.na(opt$projectdir) & !is.na(opt$resultfile) & !is.na(opt$outputdir) & !is.na(opt$imageformat)) {
  ...
  hist(data[,1], 
       col = "#1290D9", 
       main = paste("Median =", summary(data[,1])[3]), 
       xlim = c(0,2), breaks = 100, 
       xlab = "Imputation quality", ylab = "Frequency")
...
#--------------------------------------------------------------------------
### CLOSING MESSAGE
cat(paste("All done making the INFO-score plot of",study,".\n"))
cat(paste("\nToday's: ",Today, "\n"))
cat("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
